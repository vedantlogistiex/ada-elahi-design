  ...
  return (
    <>
      ...
      <div className={`bottom-sheet ${isOpen ? 'active' : ''}`} id="sheetApproval">
        ...
        <div style={{ fontSize: '15px', fontWeight: 700, color: 'var(--ada-navy)', marginBottom: '8px', lineHeight: 1.35 }}>
          {t('approvalQuestion')}
        </div>

        <div style={{ fontSize: '12.5px', color: 'var(--ada-slate)', marginBottom: '14px', lineHeight: 1.55 }}>
          {currentLang === 'ar'
        ...
        <div className="consequence-box">
          ...
          <div style={{ marginTop: '4px', fontSize: '12px', lineHeight: 1.5, color: 'var(--ada-slate)' }}>{t('consequenceDesc')}</div>
        </div>
