...
export const MoreView = () => {
  ...
  return (
    <section className="screen-view active" id="viewMore">
      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '14px 0', borderBottom: '1px solid var(--ada-border)' }}>
        <span style={{ fontSize: '13px', color: 'var(--ada-slate)', fontWeight: 500 }}>
      ...
      {/* Preferences Section */}
      <div className="section-label" style={{ marginTop: '22px' }}>{t('prefsKicker')}</div>
      ...
      <div className="card" style={{ padding: '4px 0' }}>
        <div className="card-row" style={{ cursor: 'pointer' }} onClick={toggleLanguage}>
          ...
          <span style={{ fontSize: '13px', fontWeight: 600, color: 'var(--ada-blue)' }}>
        ...
        <div className="card-row" style={{ cursor: 'pointer' }}>
          ...
          <span style={{ fontWeight: 600, color: 'var(--ada-blue)' }}>→</span>
        </div>
      </div>

      {/* Sovereign AI Governance Footer */}
      <div style={{ textAlign: 'center', padding: '32px 0 16px', fontSize: '11.5px', color: 'var(--ada-grey)', lineHeight: 1.6 }}>
